...
from .forms import UserSetupAdminForm, UserUpgradeForm
...
@account.route('/user/<int:user_id>/settings', methods=['GET', 'POST'])
...
@account.route('/user/<int:user_id>/settings/payers')
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/payer/add', methods=['GET', 'POST'])
@login_required(roles=['admin'])
def user_settings_payer_add(user_id):
    ...
    if form.validate_on_submit():
        ...
        flash('New payer has been added.')
        return redirect(url_for('account.user_settings_payers', user_id=user_id))
...
@account.route('/user/<int:user_id>/settings/payer/<int:payer_id>/edit',
            methods=['GET', 'POST'])
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/payer/csv', methods=['GET', 'POST'])
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/billing-codes')
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/billing-code/add',
            methods=['GET', 'POST'])
@login_required(roles=['admin'])
def user_billing_code_add(user_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.add(bill_code)
        flash('The billing code has been added.')
        return redirect(url_for('account.user_billing_codes', user_id=user_id))
...
@account.route('/user/<int:user_id>/settings/billing-code/csv',
            methods=['GET', 'POST'])
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/billing-code/<int:bill_id>',
            methods=['GET', 'POST'])
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/doctors')
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/doctor/add', methods=['GET', 'POST'])
@login_required(roles=['admin'])
def user_doctor_add(user_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.add(doctor)
        flash('New doctor has been added.')
        return redirect(url_for('account.user_doctors', user_id=user_id))
...
@account.route('/user/<int:user_id>/settings/doctor/csv', methods=['GET', 'POST'])
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/doctor/<int:doctor_id>/edit',
            methods=['GET', 'POST'])
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/setup', methods=['GET', 'POST'])
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/user-setup', methods=['GET', 'POST'])
@login_required(roles=['admin'])
...
@account.route('/user/<int:user_id>/settings/account', methods=['GET', 'POST'])
@login_required(roles=['admin'])
